...
class BitSieve {
     ...
     * constructor, BitSieve(DuzeLiczby base, int searchLen).  The length
     ...
     * be even.
     */
    BitSieve(DuzeLiczby base, int searchLen) {
        /*
        ...
        MutDuzeLiczby b = new MutDuzeLiczby(base);
     ...
     */
    DuzeLiczby retrieve(DuzeLiczby initValue, int certainty, java.util.Random random) {
        ...
        for (int i=0; i<bits.length; i++) {
            ...
            for (int j=0; j<64; j++) {
                if ((nextLong & 1) == 1) {
                    DuzeLiczby candidate = initValue.add(
                            DuzeLiczby.valueOf(offset));
