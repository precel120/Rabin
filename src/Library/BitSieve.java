...
class BitSieve {
     ...
     * constructor, BitSieve(CalkowicieBig base, int searchLen).  The length
     ...
     * be even.
     */
    BitSieve(CalkowicieBig base, int searchLen) {
        /*
        ...
        MutCalkowicieBig b = new MutCalkowicieBig(base);
     ...
     */
    CalkowicieBig retrieve(CalkowicieBig initValue, int certainty, java.util.Random random) {
        ...
        for (int i=0; i<bits.length; i++) {
            ...
            for (int j=0; j<64; j++) {
                if ((nextLong & 1) == 1) {
                    CalkowicieBig candidate = initValue.add(
                            CalkowicieBig.valueOf(offset));
